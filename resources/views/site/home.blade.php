    ...
    <div class="container">
        <div class="row justify-content-between gy-5">
            <div
                ...
                <h2 data-aos="fade-up">{{ $heroes->hero_title }}</h2>
                <p data-aos="fade-up" data-aos-delay="100">{{ $heroes->hero_description }}</p>
            ...
            <div class="col-lg-5 order-1 order-lg-2 text-center text-lg-start">
                <img src="{{ asset('uploads/hero/' . $heroes->hero_image) }}" class="img-fluid" alt=""
                ...
                <div class="tab-pane fade active show" id="menu-starters">
                    ...
                    <div class="row gy-5">
                        ...
                        <div class="col-lg-4 menu-item">
                            <a href="{{ asset('site/img/menu/menu-item-1.png') }}" class="glightbox"><img
                                    src="{{ asset('site/img/menu/menu-item-1.png') }}" class="menu-img img-fluid"
                                    alt=""></a>
                            <h4>Magnam Tiste</h4>
                            <p class="ingredients">
                        ...
                        <div class="col-lg-4 menu-item">
                            <a href="{{ asset('site/img/menu/menu-item-2.png') }}" class="glightbox"><img
                                    src="{{ asset('site/img/menu/menu-item-2.png') }}" class="menu-img img-fluid"
                                    alt=""></a>
                            <h4>Aut Luia</h4>
                            <p class="ingredients">
                                Lorem, deren, trataro, filede, nerada
                        ...
                        <div class="col-lg-4 menu-item">
                            <a href="{{ asset('site/img/menu/menu-item-3.png') }}" class="glightbox"><img
                                    src="{{ asset('site/img/menu/menu-item-3.png') }}" class="menu-img img-fluid"
                                    alt=""></a>
                            <h4>Est Eligendi</h4>
                            <p class="ingredients">
                                Lorem, deren, trataro, filede, nerada
                        ...
                        <div class="col-lg-4 menu-item">
                            <a href="{{ asset('site/img/menu/menu-item-4.png') }}" class="glightbox"><img
                                    src="{{ asset('site/img/menu/menu-item-4.png') }}" class="menu-img img-fluid"
                                    alt=""></a>
                            <h4>Eos Luibusdam</h4>
                            <p class="ingredients">
                                Lorem, deren, trataro, filede, nerada
                        ...
                        <div class="col-lg-4 menu-item">
                            <a href="{{ asset('site/img/menu/menu-item-5.png') }}" class="glightbox"><img
                                    src="{{ asset('site/img/menu/menu-item-5.png') }}" class="menu-img img-fluid"
                                    alt=""></a>
                            <h4>Eos Luibusdam</h4>
                            <p class="ingredients">
                                Lorem, deren, trataro, filede, nerada
                        ...
                        <div class="col-lg-4 menu-item">
                            <a href="{{ asset('site/img/menu/menu-item-6.png') }}" class="glightbox"><img
                                    src="{{ asset('site/img/menu/menu-item-6.png') }}" class="menu-img img-fluid"
                                    alt=""></a>
                        ...
                        <div class="testimonial-item">
                            <div class="row gy-4 justify-content-center">
                                ...
                                <div class="col-lg-2 text-center">
                                    <img src="{{ asset('site/img/testimonials/testimonials-1.jpg') }}"
                    ...
                    <div class="swiper-slide">
                        <div class="testimonial-item">
                            <div class="row gy-4 justify-content-center">
                                ...
                                <div class="col-lg-2 text-center">
                                    <img src="{{ asset('site/img/testimonials/testimonials-2.jpg') }}"
                                        class="img-fluid testimonial-img" alt="">
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="swiper-slide">
                        <div class="testimonial-item">
                            <div class="row gy-4 justify-content-center">
                                ...
                                <div class="col-lg-2 text-center">
                                    <img src="{{ asset('site/img/testimonials/testimonials-3.jpg') }}"
                                        class="img-fluid testimonial-img" alt="">
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="swiper-slide">
                        <div class="testimonial-item">
                            <div class="row gy-4 justify-content-center">
                                ...
                                <div class="col-lg-2 text-center">
                                    <img src="{{ asset('site/img/testimonials/testimonials-4.jpg') }}"
                                        class="img-fluid testimonial-img" alt="">
                                </div>
                            </div>
                        </div>
            ...
            <div class="slides-3 swiper" data-aos="fade-up" data-aos-delay="100">
                <div class="swiper-wrapper">
                    ...
                    <div class="swiper-slide event-item d-flex flex-column justify-content-end"
                        style="background-image: url('site/img/events-1.jpg')">
                    ...
                    <div class="swiper-slide event-item d-flex flex-column justify-content-end"
                        style="background-image: url('site/img/events-2.jpg')">
                    ...
                    <div class="swiper-slide event-item d-flex flex-column justify-content-end"
                        style="background-image: url('site/img/events-3.jpg')">
    ...
    <section id="book-a-table" class="book-a-table">
        <div class="container" data-aos="fade-up">
            ...
            <div class="row g-0">
                ...
                <div class="col-lg-4 reservation-img" style="background-image: url('site/img/reservation.jpg');"
            ...
            <div class="gallery-slider swiper">
                <div class="swiper-wrapper align-items-center">
                    <div class="swiper-slide"><a class="glightbox" data-gallery="images-gallery"
                            href="{{ asset('site/img/gallery/gallery-1.jpg') }}"><img
                                src="{{ asset('site/img/gallery/gallery-1.jpg') }}" class="img-fluid" alt=""></a>
                    </div>
                    <div class="swiper-slide"><a class="glightbox" data-gallery="images-gallery"
                            href="{{ asset('site/img/gallery/gallery-2.jpg') }}"><img
                                src="{{ asset('site/img/gallery/gallery-2.jpg') }}" class="img-fluid" alt=""></a>
                    </div>
                    <div class="swiper-slide"><a class="glightbox" data-gallery="images-gallery"
                            href="{{ asset('site/img/gallery/gallery-3.jpg') }}"><img
                                src="{{ asset('site/img/gallery/gallery-3.jpg') }}" class="img-fluid" alt=""></a>
                    </div>
                    <div class="swiper-slide"><a class="glightbox" data-gallery="images-gallery"
                            href="{{ asset('site/img/gallery/gallery-4.jpg') }}"><img
                                src="{{ asset('site/img/gallery/gallery-4.jpg') }}" class="img-fluid" alt=""></a>
                    </div>
                    <div class="swiper-slide"><a class="glightbox" data-gallery="images-gallery"
                            href="{{ asset('site/img/gallery/gallery-5.jpg') }}"><img
                                src="{{ asset('site/img/gallery/gallery-5.jpg') }}" class="img-fluid" alt=""></a>
                    </div>
                    <div class="swiper-slide"><a class="glightbox" data-gallery="images-gallery"
                            href="{{ asset('site/img/gallery/gallery-6.jpg') }}"><img
                                src="{{ asset('site/img/gallery/gallery-6.jpg') }}" class="img-fluid" alt=""></a>
                    </div>
                    <div class="swiper-slide"><a class="glightbox" data-gallery="images-gallery"
                            href="{{ asset('site/img/gallery/gallery-7.jpg') }}"><img
                                src="{{ asset('site/img/gallery/gallery-7.jpg') }}" class="img-fluid" alt=""></a>
                    </div>
                    <div class="swiper-slide"><a class="glightbox" data-gallery="images-gallery"
                            href="{{ asset('site/img/gallery/gallery-8.jpg') }}"><img
                                src="{{ asset('site/img/gallery/gallery-8.jpg') }}" class="img-fluid" alt=""></a>
                    </div>
                </div>
                <div class="swiper-pagination"></div>
            </div>
